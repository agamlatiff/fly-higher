    ...
    <div className="group bg-white dark:bg-slate-800 rounded-2xl p-5 md:p-6 shadow-sm hover:shadow-md border border-gray-200 dark:border-slate-700 transition-all duration-300">
      <div className="flex flex-col md:flex-row gap-6 items-center">
        ...
        <div className="flex-1 w-full flex items-center justify-between gap-4 text-center">
          {/* Departure */}
          <div>
            <div className="text-xl md:text-2xl font-black text-text-dark dark:text-white">
              {dateFormat(data.flight.departureDate, "HH:mm")}
            </div>
            <div className="text-gray-500 dark:text-gray-300 text-xs font-bold bg-gray-100 dark:bg-slate-700 px-2 py-1 rounded-md mt-1 inline-block">
          ...
          <div className="flex flex-col items-center flex-1 px-2 relative">
            ...
            <div className="w-full h-[2px] bg-gray-200 dark:bg-slate-600 relative rounded-full overflow-hidden">
              <div className="absolute left-0 top-0 bottom-0 w-full bg-gradient-to-r from-transparent via-sky-primary/30 to-transparent" />
            </div>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-slate-800 p-1 rounded-full border border-gray-100 dark:border-slate-600 shadow-sm">
